...
public class LookInputModule : BaseInputModule {
	...
	public float normalCursorScale = 0.002f;
	...
	public override void Process() {        
		...
		if (!ignoreInputsWhenLookAway || ignoreInputsWhenLookAway && currentLook != null) {
			...
			_buttonUsed = false;
            //Aqui se puede validar que reconozca el press de alguno de los botones del wiimote
            //Recordar que el RayCast se genera desde la posición del objeto que se asigna en el canvas como event camera
